...
class HController
{
    ...
    public function into_presence()
    {
        ...
        Flight::render('presence/pointage', $data, 'contenu');
    ...
    public function into_temp_general() {
        Flight::render('presence/tempGeneral' , [], 'contenu');
        Flight::render('shared/home');
    }

    public function into_timecards() {
        Flight::render('presence/tempDetails',[],'contenu');
        Flight::render('shared/home');
    }
    ...
    public function into_employees()
    {
        $employees = Flight::HModel()->get_generalised("employe", "*", [], [], "ORDER BY nom ASC", []);
        $data = ['employees' => $employees];
        Flight::render('presence/liste', $data, 'contenu');
        Flight::render('shared/home');
    }
    ...
    public function into_calendar()
    {
        ...
        if ($idEmp != null) {
            ...
            $poste = Flight::HModel()->get_generalised(
                "poste",
                "*",
                ["id"],
                [$id_poste],
