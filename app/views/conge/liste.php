<style>
    ...
    .table-wrapper tbody tr form {
        display: contents; /* Permet à la ligne de contenir le formulaire sans casser la structure du tableau */
    }
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr data-name="<?= strtolower($l['nom'] . ' ' . $l['prenom']) ?>" data-role="<?= strtolower($l['poste']) ?>">
                            <form action="<?= constant('BASE_URL') ?>valider_conge" method="post" style="display: contents;">
                            ...
                            <td>
                                <span>
                                    <input type="date" name="date_validation" value="<?= date('Y-m-d') ?>">
                                </span>
                            </td>
                            <td>
