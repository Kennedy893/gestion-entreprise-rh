...
<style>
    ...
    :root {
        ...
        --bg-sidebar: #0f172a;
        /* Presque noir */
        --bg-hover: rgba(20, 184, 166, 0.15);
        --text-main: #f8fafc;
        --text-muted: #94a3b8;
        --submenu-bg: #1e293b;
        --submenu-hover: rgba(20, 184, 166, 0.25);
    ...
    .sidebar.drh .nav-link i {
        width: 25px;
        margin-right: 10px;
        text-align: center;
    }

    .sidebar.drh .nav-link:hover {
        background-color: var(--bg-hover);
        color: var(--primary);
    }

    .sidebar.drh .nav-link.active {
    ...
    /* --- Sous-menus --- */
    .sidebar.drh .arrow-icon {
        transition: transform 0.3s ease;
        font-size: 0.7rem;
        color: var(--text-muted);
    }

    .sidebar.drh .nav-item.has-submenu.open .arrow-icon {
    ...
    .sidebar.drh .submenu li a:hover {
        background-color: var(--submenu-hover);
        color: white;
    }

    .sidebar.drh .nav-item.has-submenu.open .submenu {
        max-height: 500px;
    }
</style>

<nav class="sidebar-drh">
    <div class="brand">
