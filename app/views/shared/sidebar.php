...
<nav class="sidebar">
  ...
  <div class="user-profile">
    ...
    <div class="emp-details" style="text-align: left">
      <div style="color: white; font-size: 0.9rem"><?= htmlspecialchars($label) ?></div>
      <div style="color: #94a3b8; font-size: 0.75rem"><?= htmlspecialchars($label) ?></div>
    </div>
  </div>
</nav>
